...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "wuwuFQ"
  # spec.authors            = { "wuwuFQ" => "13301325631@163.com" }
  # spec.social_media_url   = "https://twitter.com/wuwuFQ"
  ...
  spec.source       = { :git => "http://github.com/wuwuFQ/FQLockSDK.git", :tag => "#{spec.version}" }
